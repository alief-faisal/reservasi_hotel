...
<head>
    ...
    .grid-diskon-slider {
        ...
        /* Tampil 4 kolom penuh sejajar ke samping */
        gap: 20px;
        width: 100%;
    }
    ...
    @media (max-width: 768px) {
        ...
        .grid-diskon-slider {
            ...
            /* Berubah jadi deretan baris memanjang */
            gap: 15px;
            overflow-x: auto;
            user-select: none;
            /* Cegah text ter-blokir biru saat di-drag mouse */
        ...
        .grid-diskon-slider::-webkit-scrollbar {
            display: none;
            /* Hilangkan scrollbar bawaan Chrome/Safari */
        }

        /* Card dibuat simetris (tampil 2 utuh pas, pakai perhitungan flex basis) */
        ...
        /* Hanya aktifkan efek magnet otomatis jika dibuka lewat layar sentuh asli HP */
...
<body>
    ...
    <main class="container">
        ...
        <section class="flex-hotel" style="display: block !important;">
            ...
            <div id="actual-content" style="width: 100% !important; display: block !important;">
                ...
                <!-- SECTION DISKON: DESKTOP 4 KOLOM FULL, MOBILE SIMETRIS SLIDER BISA DI-DRAG MOUSE -->
    ...
    <!-- JAVASCRIPT OLAHAN ULTRA SMOOTH: Mendukung Drag Mouse Sempurna saat di-resize ke Mobile -->
    <script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        wrappers.forEach(wrapper => {
            ...
            // Event Mouse Down (Klik & Tahan)
            wrapper.addEventListener('mousedown', (e) => {
                // Hanya jalankan drag mouse jika resolusi layar berada di ukuran mobile
            ...
            // Event Mouse Leave (Kursor Keluar Area)
            wrapper.addEventListener('mouseleave', () => {
                isDown = false;
                wrapper.style.cursor = 'grab';
            });

            // Event Mouse Up (Klik Dilepas)
            wrapper.addEventListener('mouseup', () => {
                isDown = false;
                wrapper.style.cursor = 'grab';
            });

            // Event Mouse Move (Seret Kursor)
            wrapper.addEventListener('mousemove', (e) => {
                ...
                const walk = (x - startX) * 1.5; // Angka pengali kelancaran geser
                slider.scrollLeft = scrollLeft - walk;
            });

            // Mencegah Link Hotel Terbuka Sendiri Saat User Sedang Niat Nge-drag Menggunakan Mouse
        ...
        // Set kursor awal pertanda bisa digeser di mobile view desktop browser
        if (window.innerWidth <= 768) {
            wrappers.forEach(w => w.style.cursor = 'grab');
        }
    });
    </script>
</body>
